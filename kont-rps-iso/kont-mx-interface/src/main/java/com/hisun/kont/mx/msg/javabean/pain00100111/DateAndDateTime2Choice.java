...
@XmlType(name = "DateAndDateTime2Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "dt",
    "dtTm"
})
public class DateAndDateTime2Choice {
    ...
    @XmlElement(name = "DtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
