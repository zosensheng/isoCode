 ...
 * 
 * <p>RemittanceInformation21 complex type 的 Java 类。
 * 
...
@XmlType(name = "RemittanceInformation21", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "ustrd",
    "strd"
})
public class RemittanceInformation21 {

    @XmlElement(name = "Ustrd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected List<String> ustrd;
    @XmlElement(name = "Strd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
