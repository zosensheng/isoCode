...
@XmlType(name = "RemittanceAmount3", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "duePyblAmt",
    "dscntApldAmt",
    "cdtNoteAmt",
    "taxAmt",
...
public class RemittanceAmount3 {
    ...
    @XmlElement(name = "DuePyblAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected ActiveOrHistoricCurrencyAndAmount duePyblAmt;
    @XmlElement(name = "DscntApldAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected List<DiscountAmountAndType1> dscntApldAmt;
    @XmlElement(name = "CdtNoteAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    ...
    @XmlElement(name = "AdjstmntAmtAndRsn", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
