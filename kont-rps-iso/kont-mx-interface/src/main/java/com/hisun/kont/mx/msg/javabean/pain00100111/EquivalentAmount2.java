...
@XmlType(name = "EquivalentAmount2", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "amt",
    "ccyOfTrf"
})
public class EquivalentAmount2 {
    ...
    @XmlElement(name = "CcyOfTrf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", required = true)
