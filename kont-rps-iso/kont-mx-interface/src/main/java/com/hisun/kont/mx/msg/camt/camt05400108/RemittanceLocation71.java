...
/**
 * <p>RemittanceLocation7__1 complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="RmtId" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}CBPR_RestrictedFINXMax35Text" minOccurs="0"/>
 *         &lt;element name="RmtLctnDtls" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}RemittanceLocationData1__1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RemittanceLocation7__1",  propOrder = {
    "rmtId",
    "rmtLctnDtls"
})
public class RemittanceLocation71 {
    ...
    public List<RemittanceLocationData11> getRmtLctnDtls() {
        if (rmtLctnDtls == null) {
            rmtLctnDtls = new ArrayList<RemittanceLocationData11>();
        }
