 ...
 *       &lt;sequence>
 *         &lt;element name="DuePyblAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="DscntApldAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09}DiscountAmountAndType1__1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CdtNoteAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09}TaxAmountAndType1__2" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AdjstmntAmtAndRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09}DocumentAdjustment1__1" maxOccurs="unbounded" minOccurs="0"/>
...
public class RemittanceAmount21 {
    ...
    protected List<TaxAmountAndType12> taxAmt;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TaxAmountAndType12 }
     * 
     * 
     */
    public List<TaxAmountAndType12> getTaxAmt() {
        if (taxAmt == null) {
            taxAmt = new ArrayList<TaxAmountAndType12>();
        }
        return this.taxAmt;
    }
