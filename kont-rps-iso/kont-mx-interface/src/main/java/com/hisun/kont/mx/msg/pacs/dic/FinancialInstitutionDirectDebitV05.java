 ...
 * 
 * 
 * <p>FinancialInstitutionDirectDebitV05 complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="FinancialInstitutionDirectDebitV05">
 *   &lt;complexContent>
 *     &lt;restriction base="{http:
 *       &lt;sequence>
 *         &lt;element name="GrpHdr" type="{}GroupHeader92"/>
 *         &lt;element name="CdtInstr" type="{}CreditTransferTransaction53" maxOccurs="unbounded"/>
...
@XmlType(name = "FinancialInstitutionDirectDebitV05", propOrder = {
    "grpHdr",
    "cdtInstr",
    "splmtryData"
})
public class FinancialInstitutionDirectDebitV05 {
    ...
    protected List<CreditTransferTransaction53> cdtInstr;
     ...
     *     
     */
    public void setGrpHdr(GroupHeader92 value) {
        this.grpHdr = value;
    }
     ...
     * {@link CreditTransferTransaction53 }
     * 
     * 
     */
    public List<CreditTransferTransaction53> getCdtInstr() {
        if (cdtInstr == null) {
            cdtInstr = new ArrayList<CreditTransferTransaction53>();
        }
