...
import com.hisun.kont.mx.msg.model.*;
...
public class MxParseUtils {
    ...
    /**
     * use {@link #parseSAXSource(SAXSource, Class, Class[], MxReadParams)} instead
     */
    public static Object parseSAXSource(final SAXSource source, final Class targetClass, final Class<?>[] classes) {
