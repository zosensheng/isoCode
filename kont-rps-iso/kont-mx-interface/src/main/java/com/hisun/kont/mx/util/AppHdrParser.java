...
import com.hisun.kont.mx.msg.AppHdr.BusinessAppHdrV02;
import com.hisun.kont.mx.msg.javabean.head00100102.BusinessApplicationHeaderV02;
import com.hisun.kont.mx.msg.model.AppHdr;
import com.hisun.kont.mx.msg.model.MxReadParams;
import com.hisun.kont.mx.msg.model.NamespaceReader;
...
public class AppHdrParser {
    ...
    private static AppHdr parseHeaderFromSAXSource(final String xml, final String namespace, final MxReadParams params) {
        ...
        return (BusinessApplicationHeaderV02) MxParseUtils.parseSAXSource(source, BusinessApplicationHeaderV02.class, BusinessApplicationHeaderV02._classes, params);
    }
