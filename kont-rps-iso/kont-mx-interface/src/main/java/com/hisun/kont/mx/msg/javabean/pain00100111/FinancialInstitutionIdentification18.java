...
@XmlType(name = "FinancialInstitutionIdentification18", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "bicfi",
    "clrSysMmbId",
    "lei",
    "nm",
...
public class FinancialInstitutionIdentification18 {
    ...
    @XmlElement(name = "BICFI", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected String bicfi;
    @XmlElement(name = "ClrSysMmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected ClearingSystemMemberIdentification2 clrSysMmbId;
    @XmlElement(name = "LEI", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
