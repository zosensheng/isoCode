 ...
 * 
 * <p>RemittanceLocation7 complex type 的 Java 类。
 * 
...
@XmlType(name = "RemittanceLocation7", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "rmtId",
    "rmtLctnDtls"
})
public class RemittanceLocation7 {

    @XmlElement(name = "RmtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    protected String rmtId;
    @XmlElement(name = "RmtLctnDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
