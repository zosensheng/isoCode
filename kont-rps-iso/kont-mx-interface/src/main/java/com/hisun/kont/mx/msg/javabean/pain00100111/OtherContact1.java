...
@XmlType(name = "OtherContact1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "chanlTp",
    "id"
})
public class OtherContact1 {

    @XmlElement(name = "ChanlTp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", required = true)
