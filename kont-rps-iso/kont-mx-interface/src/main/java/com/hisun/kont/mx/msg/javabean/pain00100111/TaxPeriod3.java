 ...
 * 
 * <p>TaxPeriod3 complex type 的 Java 类。
 * 
...
@XmlType(name = "TaxPeriod3", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "yr",
    "tp",
    "frToDt"
})
public class TaxPeriod3 {
    ...
    @XmlElement(name = "Yr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
    ...
    @XmlElement(name = "FrToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
