...
/**
 * <p>Party40Choice__4 complex type的 Java 类。
 * 
 ...
 *       &lt;choice>
 *         &lt;element name="Pty" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}PartyIdentification135__6"/>
...
@XmlType(name = "Party40Choice__4",  propOrder = {
    "pty",
    "agt"
})
public class Party40Choice4 {
    ...
    @XmlElement(name = "Pty")
    protected PartyIdentification1356 pty;
    @XmlElement(name = "Agt")
     ...
     *     
     */
    public PartyIdentification1356 getPty() {
        return pty;
    }
     ...
     *     
     */
    public void setPty(PartyIdentification1356 value) {
        this.pty = value;
    }
