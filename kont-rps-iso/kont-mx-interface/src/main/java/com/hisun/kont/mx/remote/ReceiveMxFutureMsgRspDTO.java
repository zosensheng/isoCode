...
public class ReceiveMxFutureMsgRspDTO {
    @ApiModelProperty(
        name = "funCd",
        value = "功能码"
    )
    ...
    public ReceiveMxFutureMsgRspDTO() {
    }
...
//    }
    ...
    public String toString() {
        return "ReceiveFutureMsgRspDTO {funCd = '" + this.funCd + "', errCd = '" + this.errCd + "', frSys = '" + this.frSys + "', id22 = '" + this.id22 + "', resndInd = '" + this.resndInd + "', rejInd = '" + this.rejInd + "', impsInd = '" + this.impsInd + "', tlgpBank = '" + this.tlgpBank + "', tlgpOsn = '" + this.tlgpOsn + "', tlgpRecno = '" + this.tlgpRecno + "', open39 = '" + this.open39 + "', rspHead = '" + this.rspHead + "'}";
    }
}
