...
//        }
    ...
    public Constraints checkC46() {
        if (JudgeUtils.isNotNull(this.getFIToFICstmrCdtTrf())) {
            FIToFICustomerCreditTransferV08 fiToFICstmrCdtTrf = this.getFIToFICstmrCdtTrf();
            if (JudgeUtils.isNotNull(fiToFICstmrCdtTrf.getCdtTrfTxInf())) {
                com.hisun.kont.mx.msg.pacs.pacs00800108stp.CreditTransferTransaction391 cdtTrfTxInf = fiToFICstmrCdtTrf.getCdtTrfTxInf();
                com.hisun.kont.mx.msg.pacs.pacs00800108stp.PaymentIdentification71 pmtId = cdtTrfTxInf.getPmtId();
