...
@XmlType(name = "DocumentLineInformation1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "id",
    "desc",
    "amt"
})
public class DocumentLineInformation1 {
    ...
    @XmlElement(name = "Desc", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
