...
/**
 * <p>OrganisationIdentification29__3 complex type的 Java 类。
 * 
 ...
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}GenericOrganisationIdentification1__3" maxOccurs="2" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OrganisationIdentification29__3", propOrder = {
    "anyBIC",
    "lei",
    "othr"
})
public class OrganisationIdentification293 {
    ...
    public List<GenericOrganisationIdentification13> getOthr() {
        if (othr == null) {
            othr = new ArrayList<GenericOrganisationIdentification13>();
        }
        return this.othr;
    }
