 ...
 *         &lt;element name="DscntApldAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}DiscountAmountAndType1__2" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}TaxAmountAndType1__1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AdjstmntAmtAndRsn" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}DocumentAdjustment1__1" maxOccurs="unbounded" minOccurs="0"/>
...
public class RemittanceAmount21 {
    ...
    protected List<DiscountAmountAndType12> dscntApldAmt;
     ...
     * {@link DiscountAmountAndType12 }
     * 
     * 
     */
    public List<DiscountAmountAndType12> getDscntApldAmt() {
        if (dscntApldAmt == null) {
            dscntApldAmt = new ArrayList<DiscountAmountAndType12>();
        }
