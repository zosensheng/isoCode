            ...
            if (JudgeUtils.isNotNull(grpHdr)) {
                ...
                if (JudgeUtils.isNotNull(sttlmInf)) {
                    ...
                    if (JudgeUtils.isNotNull(instdRmbrsmntAgtAcct) && JudgeUtils.isNull(instdRmbrsmntAgt)) {
                        return new Constraints(Pacs00900108ErrorConstant.C13_ERROR_SEVERITY, Pacs00900108ErrorConstant.C13_ERROR_CODE, Pacs00900108ErrorConstant.C13_ERROR_TEXT);
                    }
                }
            }
        }
