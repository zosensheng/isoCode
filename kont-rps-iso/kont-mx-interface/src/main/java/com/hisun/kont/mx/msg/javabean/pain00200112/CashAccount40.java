...
@XmlType(name = "CashAccount40", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12", propOrder = {
    "id",
    "tp",
    "ccy",
    "nm",
...
public class CashAccount40 {
    ...
    @XmlElement(name = "Ccy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12")
    protected String ccy;
    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12")
    protected String nm;
    @XmlElement(name = "Prxy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12")
