...
@XmlType(name = "AmountType4Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "instdAmt",
    "eqvtAmt"
})
public class AmountType4Choice {
    ...
    @XmlElement(name = "EqvtAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
