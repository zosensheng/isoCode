...
@XmlType(name = "DocumentAdjustment1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "amt",
    "cdtDbtInd",
    "rsn",
    "addtlInf"
...
public class DocumentAdjustment1 {
    ...
    @XmlElement(name = "CdtDbtInd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
