...
@XmlType(name = "FrequencyAndMoment1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "tp",
    "ptInTm"
})
public class FrequencyAndMoment1 {
    ...
    @XmlElement(name = "PtInTm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", required = true)
