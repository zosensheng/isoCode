...
@XmlType(name = "FrequencyPeriod1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "tp",
    "cntPerPrd"
})
public class FrequencyPeriod1 {
    ...
    @XmlElement(name = "CntPerPrd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", required = true)
