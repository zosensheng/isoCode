...
@XmlType(name = "TaxAuthorisation1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11", propOrder = {
    "titl",
    "nm"
})
public class TaxAuthorisation1 {

    @XmlElement(name = "Titl", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.11")
