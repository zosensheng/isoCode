...
import com.hisun.kont.mx.deprecation.ProwideDeprecated;
import com.hisun.kont.mx.deprecation.TargetYear;
...
import com.hisun.kont.mx.msg.model.XsysNamespaces;
...
public class MxWriteImpl implements MxWrite {
    ...
    /**
     * @deprecated use {@link #(String, AbstractMX, Class[], MxWriteParams)} instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static String write(String namespace, Object obj, Class[] classes, final String prefix, boolean includeXMLDeclaration, EscapeHandler escapeHandler) {
        MxWriteParams params = new MxWriteParams();
        params.prefix = prefix;
        params.includeXMLDeclaration = includeXMLDeclaration;
     ...
     * @since 9.2.6
     */
    public static String write(String namespace, Object obj, Class[] classes, MxWriteParams params) {
...
//        Objects.requireNonNull(classes, "Class[] can not be null");
        ...
        try {
            JAXBContext context = JaxbContextLoader.INSTANCE.get(obj.getClass(),classes);

            // Sin el ns en el qname, para ver si toma el default
            @SuppressWarnings({"unchecked"}) final JAXBElement element = new JAXBElement(new QName("Document"), obj.getClass(), null, obj);
