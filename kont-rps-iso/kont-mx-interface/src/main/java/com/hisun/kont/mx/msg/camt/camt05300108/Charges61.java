...
/**
 * <p>Charges6__1 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="Charges6__1">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Rcrd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.08}ChargesRecord3__1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Charges61 {
     ...
     * {@link ChargesRecord31 }
     * 
     * 
     */
    public List<ChargesRecord31> getRcrd() {
        if (rcrd == null) {
            rcrd = new ArrayList<ChargesRecord31>();
        }
        return this.rcrd;
    }
