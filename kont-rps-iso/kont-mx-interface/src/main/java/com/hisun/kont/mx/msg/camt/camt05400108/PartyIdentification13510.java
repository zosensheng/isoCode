...
/**
 * <p>PartyIdentification135__10 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PartyIdentification135__10">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}Party38Choice__4" minOccurs="0"/>
 *         &lt;element name="CtryOfRes" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}CountryCode" minOccurs="0"/>
 *         &lt;element name="CtctDtls" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}Contact4__3" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PartyIdentification135__10",  propOrder = {
    "nm",
    "pstlAdr",
    "id",
    "ctryOfRes",
...
public class PartyIdentification13510 {
     ...
     *     
     */
    public void setId(Party38Choice4 value) {
        this.id = value;
    }
