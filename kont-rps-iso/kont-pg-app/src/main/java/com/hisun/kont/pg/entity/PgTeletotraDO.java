 ...
 * @date 2021-10-22
 */
public class PgTeletotraDO extends BaseDO {
	...
	// Constructor
	public PgTeletotraDO() {
	}

	/**
	 * full Constructor
	 */
	public PgTeletotraDO(String pgswfId, String glyph, String ucs, String hostCode, String telexCode, String teleAction, LocalDateTime updatedLastTime) {
